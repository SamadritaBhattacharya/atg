...
const Testimonial = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row items-center justify-center p-6">
      <div className="bg-slate-100 rounded-lg  shadow-md p-8 max-w-4xl w-full">
        {/* Header */}
        ...
        <div className="mb-6 flex justify-between w-full ">
          <div className="flex items-center justify-between bg-purple-100 p-4  w-[60%] mx-auto rounded-lg">
          ...
          <div className=' w-[30%] mx-auto bg-gray-50 rounded-lg hidden lg:block'>
          <div className="flex items-center ">
          {/* <img
            className="w-16 h-16 rounded-full mr-4"
            src="D:\atg\public\dance.png" // Replace this with the actual image URL
            alt="User profile"
          /> */}
