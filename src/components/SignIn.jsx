...
const SignIn = () => {
  ...
  return (
    <div className=" flex items-center justify-center ">
      <div className="bg-slate-200 shadow-md rounded-xl p-4 max-w-md w-full">
        ...
        <form className="space-y-4">
          ...
          {/* Password Strength */}
          <p className="text-right text-sm text-gray-500 mt-1">Password strength</p>
          ...
          <button
            type="submit"
            className="w-full bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 focus:ring-4 focus:ring-purple-300"
          >
            Agree and Continue
          </button>
        </form>
